...
# # 解决和python3-rpm-generators-6-2.el7.noarch的冲突
# mv $RPM_BUILD_ROOT/%{rpmhome}/pythondistdeps.py $RPM_BUILD_ROOT/%{rpmhome}/pythondistdeps.py.bak
...
%files build
%exclude %{rpmhome}/pythondistdeps.py
%{_bindir}/rpmbuild
%{_bindir}/gendiff
%{_bindir}/rpmspec
